...
import ViewSchedWorkerBtn from '@/pages/Schedule/EditScheduleModal/ViewSchedWorkerBtn';
import SMSNotificationModal from '@/pages/Schedule/EditScheduleModal/SendSMSNotificationModal';

export default function ScheduledWorkersList({ shiftId }) {
  ...
  return (
    <>
      <ViewSchedWorkerBtn
        toggleScheduledWorkersView={toggleScheduledWorkersView}
        scheduledWorkersView={scheduledWorkersView}
      />
