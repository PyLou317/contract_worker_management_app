...
export default function ScheduleList({
  ...
  return (
    <>
      <div className="container mx-auto px-6 py-4 mt-4 bg-white shadow-md rounded-2xl overflow-x-auto">
        <div
        ...
        {isOpen && (
          <table className="w-full table-auto border-collapse border border-gray-300 rounded-lg overflow-hidden mt-6">
