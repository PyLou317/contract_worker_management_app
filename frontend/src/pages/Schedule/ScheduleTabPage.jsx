...
export default function ScheduleTabPage() {
  ...
  return (
    <>
      <CreateScheduleForm />
      <div className="container mx-auto flex flex-col w-full p-2">
      ...
      />
      <ScheduleList title="Upcoming Schedules" schedules={upcomingSchedules} />
      <ScheduleList title="Archived Schedules" schedules={archivedSchedules} />
    </>
  );
}
